    ...
    return (
        ...
        <div className="booklist-container">
            ...
            <div className="search-books">
                ...
                <div className="sort-box">
                    <select onClick={e => setSort(e.target.value)} className="sort-container">
                        <option className="sort-option" id='sort_by' selected={true} disabled="disabled">Sort By</option>
            ...
            <div className="pagination">
                ...
                {pages.map((pageIndex) => (
                    <button key={pageIndex} className={`pagination-no`} onClick={() => setPageNumber(pageIndex+1)}>{pageIndex + 1}</button>
                ))}
